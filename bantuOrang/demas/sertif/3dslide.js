...
(function($) {
  ...
  $('.selected-image').css('background', 'grey');;
   document.getElementsByClassName('selected-image')[pluginData.currentCenterNum-1].style.background="#17a2b8";
